...
const GestionCotizaciones = () => {
    ...
    const cargarDatos = useCallback(async function () {
        setCargando(true);
        try {
            const resCotizaciones = await axios.get('http://localhost:5000/api/cotizaciones');
            const resClientes = await axios.get('http://localhost:5000/api/clientes');
    ...
    const aprobarCotizacion = useCallback(async function (cotizacion) {
        ...
        try {
            const res = await axios.put('http://localhost:5000/api/cotizaciones/' + cotizacion.idCotizacion + '/aprobar', {
    ...
    const rechazarCotizacion = useCallback(async function (idCotizacion) {
        ...
        try {
            const res = await axios.put('http://localhost:5000/api/cotizaciones/' + idCotizacion + '/rechazar');
            if (res.data.success) {
